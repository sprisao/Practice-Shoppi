...
import com.shoppi.kotlin.databinding.ItemCategoryTopSellingSectionBinding
...
class CategoryTopSellingSectionAdapter :
    ...
    override fun onBindViewHolder(
        holder: TopSellingSectionViewHolder, position: Int
    ) {
...
class TopSellingDiffCallback : DiffUtil.ItemCallback<TopSelling>() {
    override fun areItemsTheSame(
        oldItem: TopSelling, newItem: TopSelling
    ): Boolean {
